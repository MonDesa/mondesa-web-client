      ...
      <Container maxWidth="lg">
        <Toolbar disableGutters>
          <Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1 }}>
            <Box component="a" href={HOME_PATH} sx={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
              <Box component="img" src="/logo.svg" alt="MonDesa Logo" sx={{ height: { xs: 32, sm: 40 }, mr: 1 }} />
              <Typography
                variant="h6"
                sx={{
                  color: 'text.primary',
          ...
          >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 2, borderBottom: '1px solid', borderColor: 'divider' }}>
              <Box component="a" href={HOME_PATH} sx={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }} onClick={closeDrawer}>
