import { Box, Button, Container, Typography, Grid, Chip, Paper, Link } from '@mui/material';
...
import { getProjectById, getTranslation, type ProjectData, PROJECT_IDS, PROJECT_TRANSLATION_KEYS } from '../constants/translations';
...
const ProjectDetail = ({ slug }: ProjectDetailProps) => {
    ...
    const project = getProjectById(slug, language, getTranslation);
